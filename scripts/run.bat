...
python demo_fusion.py -e="demo_fusion_svgp_250" -m="svgp" -n_ind_pts=250 --max_iter=2000
python demo_fusion.py -e="demo_fusion_svgp_500" -m="svgp" -n_ind_pts=500 --max_iter=5000
...
python exp_acrim.py -e="exp_acrim_svgp_250" -m="svgp" -n_ind_pts=250 --max_iter=2000
